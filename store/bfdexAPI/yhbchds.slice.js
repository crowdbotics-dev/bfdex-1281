...
export const api_v1_yhbchd_list = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_list",
  async payload => {
    const response = await apiService.api_v1_yhbchd_list(payload)
    return response.data
  }
)
export const api_v1_yhbchd_create = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_create",
  async payload => {
    const response = await apiService.api_v1_yhbchd_create(payload)
    return response.data
  }
)
export const api_v1_yhbchd_retrieve = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_retrieve",
  async payload => {
    const response = await apiService.api_v1_yhbchd_retrieve(payload)
    return response.data
  }
)
export const api_v1_yhbchd_update = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_update",
  async payload => {
    const response = await apiService.api_v1_yhbchd_update(payload)
    return response.data
  }
)
export const api_v1_yhbchd_partial_update = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_partial_update",
  async payload => {
    const response = await apiService.api_v1_yhbchd_partial_update(payload)
    return response.data
  }
)
export const api_v1_yhbchd_destroy = createAsyncThunk(
  "yhbchds/api_v1_yhbchd_destroy",
  async payload => {
...
const yhbchdsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_yhbchd_list.pending, (state, action) => {
